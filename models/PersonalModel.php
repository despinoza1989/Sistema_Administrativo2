...
class PersonalModel {
    ...
    function create($data) {
        ...
        $conexion= Database::connect();
        $queryInsert = "INSERT INTO personal (rut_personal, telefono_personal, nombre_personal, apellidos_personal, email_personal, direccion_personal, fecha_nacimiento_p, usuario_personal, password_personal, estado_usuario_personal, id_tipo_usuario_p, id_estado_civil, id_genero) VALUES ('". $data['rut_personal']."', '". $data['telefono_personal']."', '". $data['nombre_personal']."', '". $data['apellidos_personal']."', '". $data['email_personal']."', '". $data['direccion_personal']."', '". $data['fecha_nacimiento_p']."', '". $data['usuario_personal']."', '". $data['password_personal']."', '". $data['estado_usuario_personal']."', '". $data['id_tipo_usuario_p']."', '". $data['id_estado_civil']."', '". $data['id_genero']."')";
