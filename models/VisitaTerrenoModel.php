...
class VisitaTerrenoModel {
    ...
    function getById($id_visita_terreno) {
        ...
        LEFT JOIN personal AS p ON v.id_personal_vt = p.id_personal
        LEFT JOIN cliente AS c ON c.id_cliente = v.id_cliente_vt
        WHERE id_visita_terreno  = '". $id_visita_terreno ."'";
    ...
    function getAllByVisita($id_personal) {
        ...
        LEFT JOIN personal AS p ON p.id_personal = v.id_personal_vt
        LEFT JOIN cliente AS c ON c.id_cliente = v.id_cliente_vt
        LEFT JOIN asignacion_profesional AS a ON a.id_asignacion_profesional = v.id_personal_vt WHERE p.id_personal  = '". $id_personal ."'";
        $result = $conexion->query($query);
        $response = array();
        while($row = mysqli_fetch_assoc($result)) {
