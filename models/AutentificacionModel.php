...
class AutentificacionModel{
    ...
    public function doLogin($usuario, $password){
        ...
        $consulta="SELECT usuario_personal, id_personal FROM personal WHERE usuario_personal='$usuario' AND password_personal= md5('$password') AND estado_usuario_personal = 1";
